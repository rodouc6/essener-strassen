...
- Straßen gesamt: 3338
- davon `status=automatisch` (Basis der Konkordanz): 3097
- davon `status=unsicher` (ausgeschlossen): 241
- Konkordanzeinträge: **425**
  - davon `eindeutig=ja`: 386 / `eindeutig=nein` (Kollisionen): 39
  - davon mit Klammerzusatz (z. B. „(tlw.)", „(Verl.)"): 134
- Prüffälle (`daten/pruefung_konkordanz.csv`): **69**
